...
describe('deletComment', () => {
    ...
    it('should throw an Error when User is not owner of Blog', async() => {
        ...
        mockedCommentRepositry.deleteById.mockResolvedValue(false)

        await expect(commentService.deleteBlog('12345', '123')).rejects.toThrow(InsufficientPermissionsError)
    })
})
